...
@section('body')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb float-sm-left pl-3">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('page-admin-product-list') }}" title="Quản lý sản phẩm">Quản lý
                                sản phẩm</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="validation-form" method="post" action="{{ route('do-admin-product-add') }}"
                        ...
                        <div class="card-body">
                            <div class="form-group-category row">
                                ...
                                <div class="form-group col-xl-6 col-sm-4">
                                    <label class="d-block" for="select-brand">Thương hiệu:</label>
                                    <input type="text" class="form-control for-seo text-sm" name="brand"
                                           id="product_brand" placeholder="Tên thương hiệu"
                            ...
                            <div class="card card-default color-palette-box card-primary card-outline text-sm">
                                ...
                                <div class="card-body card-article">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label class="d-block" for="sale_price">Giá sale:</label>
                                            <div class="input-group">
