        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card-footer text-sm sticky-top">
                    <a class="btn btn-sm bg-gradient-primary text-white" href="{{ route('page-admin-product-add') }}"
                    ...
                    <div class="form-inline form-search d-inline-block align-middle ml-3">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <a class="btn btn-sm bg-gradient-danger text-white ml-1" href="{{ route('page-admin-product-list') }}"
                                ...
                                @foreach ($dsProduct as $k => $item)
                                    ...
                                    <tbody>
                                        <tr data-id="{{ $item->id }}">
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('page-admin-product-update', ['id' => $item->id]) }}"
                                                    title="{{ $item->name }}">
                                            ...
                                            <td class="align-middle">
                                                <a class="text-dark text-break"
                                                    href="{{ route('page-admin-product-update', ['id' => $item->id]) }}"
