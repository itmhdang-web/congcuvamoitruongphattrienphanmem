            ...
            <tbody>
                <tr data-id="{{ $item->id }}">
                    ...
                    <td class="align-middle">
                        <a href="{{ route('page-user-product-detail', ['id' => $item->id_product]) }}" title="{{ $item->name }}">
                    ...
                    <td class="align-middle text-center">
                        <a class="text-dark text-break" title="{{ $item->name_product }}" href="{{ route('page-user-product-detail', ['id'=> $item->id_product]) }}">{{ $item->name_product
                            }}</a>
                    </td>
                    <td class="align-middle text-center">
